...
const PortfolioDetails = () => {
  return (
    <Layout>
      <Breadcumb
        pageName={
          "Accelerating Digital Transformation: Streamlining Operations for ABC Software Solutions "
        }
                ...
                <div className="csd-info">
                  ...
                  <ul>
                    ...
                    <li className="hr-4">
                      ...
                      <span>
                        Business Process Optimization – Management Consulting
                      </span>{" "}
                    </li>
                    <li className="hr-4">
              ...
              <div className="service-details-icon-box">
                <div className="service-page-title2">
                  ...
                  <p style={{ textAlign: "justify" }}>
                    ABC Software Solutions, a growing software development
                    company, recognized the need to enhance operational
                    efficiency and drive digital transformation to meet the
                    evolving needs of their clients. They partnered with Codup
                    for business process optimization consulting services to
              ...
              <div className="service-details-icon-box">
                ...
                <div className="widget-service-details-icon">
                  ...
                  <p>
                    ...
                    <span>
                      {" "}
                      Streamline workflows and eliminate bottlenecks to reduce
                  ...
                  <p>
                    ...
                    <span>
                      {" "}
                      Optimize resource allocation and utilization to maximize
                  ...
                  <p>
                    ...
                    <span>
                      ...
                      for better alignment and coordinated efforts.
                    </span>
                  </p>
                  ...
                  <p>
                    ...
                    <span>
                      {" "}
                      Implement scalable solutions and technologies to support
                      the company's growth and future requirements.
                    </span>
                  </p>
                </div>
              </div>
