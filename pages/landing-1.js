        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="consen-section-title">
                <h5>Passionate about empowering businesses for growth </h5>
                <h3>
                  {" "}
                  Experience the unmatched value of Codup's consulting service
                </h3>
                <h3>
                  {" "}
                  Codup's <span> Consulting Service </span>
                </h3>
          ...
          <div className="row align-items-center">
            <div className="col-lg-7 col-md-6">
              <div className="consen-section-title white pb-4 pb-lg-5">
                <h5> Empower </h5>
                <h2> Guiding principles for </h2>
                <h2>
                  {" "}
                  how <span> we operate </span>
                </h2>
              </div>
            </div>
            <div className="col-lg-5 col-md-6">
